...
if(!$retval){
    ...
    ?>
    <img src="../images/rajarshi logo final.png" alt="LOGO" width="80px" style="float:right"></img>
    <p><b>RAJARSHI GURUKUL</b><br/>
    Sallaghari, Bhaktapur - 17<br/>
    Tel: +977 1 6612232<br/>
    Email: contact@rajarshigurukul.edu.np<br/>
    Website: http://www.rajarshigurukul.edu.np<br/></p>
    
    <p align="right" style="padding-right:10px">Order ID: <strong><?php echo $row[0]; ?></strong></p>
    <hr></hr>
   ...
   <table class="table table-responsive table-bordered" style="width:400px; height: 200px" >
       <tr><th>Particulars</th><th>Remarks</th></tr>
       <?php 
        if($row[3]!=""){
       ?>
