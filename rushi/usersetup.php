...
// if everything is ok, try to upload file
    ...
    $sql = "insert into tbl_users(fullName, userName, passWord, email, userMode,imageURL, loginTime, code, grade) values('$fullname','$username','$password','$email','$mode','$target_file','$logintime','abc','$grade')";
    
    $retval = mysqli_query($con, $sql);
    if(! $retval )
        {
            die('Could not enter data: ' . connect_error());
        }
    } else {
