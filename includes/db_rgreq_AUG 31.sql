...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2017 at 09:07 AM
...
CREATE TABLE `tbl_order` (
  ...
  `stupurpose` varchar(200) NOT NULL,
  `teapurpose` varchar(200) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
('RG/0001/2016', 'Aryan Kumar', 'Nine', 'A', 'Lalitpur', 'Rock', '9841545434', '9865676545', '015544343', '2005/12/12', 'BO1', 'Male', 'football', 'volleyball', '../uploads/picture001.jpg');
...
(9, 'Rushi Bhaju', 'rushi', 'eb4fcac30a12596187ad6f4aab529ddf', 'rushi@rajarshigurukul.edu.np', 'admin', '', '2016-03-22', '', 0, ''),
(14, 'Srijana', 'shri', 'dcb65b9e1bbb389e800c472875a937ac', 'shri@rajarshigurukul.edu.np', 'store', '', '2016-03-22', '', 0, ''),
(15, 'Hari Sanjel', 'hari', 'a9bcf1e4d7b95a22e2975c812d938889', 'harisanjel@gmail.com', 'staff', '', '2016-03-26', '', 1, 'Nine'),
(25, 'Bhushan', 'bhushan', 'cf1852c25f0fad4d1c0eb5f71e3fe5cb', 'bhushan@rajarshigurukul.edu.np', 'staff', '../uploads/Grade 5 RG copy.jpg', '2016-04-02', '', 0, 'Eight'),
...
(51, 'Rashmi Dahal', 'rashmi', '1253208465b1efa876f982d8a9e73eef', 'rashmi@rajarshigurukul.edu.np', 'staff', '../uploads/JAYA DV 1.jpg', '2017-02-28', '', 0, 'Six');
...
--
ALTER TABLE `tbl_absentees`
  MODIFY `ab_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
--
-- AUTO_INCREMENT for table `tbl_complain`
--
ALTER TABLE `tbl_complain`
  MODIFY `complainID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tbl_compliment`
--
ALTER TABLE `tbl_compliment`
  MODIFY `complimentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
